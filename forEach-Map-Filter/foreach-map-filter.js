...
function vowelCount(str){
   ...
   newArr.forEach(function(value){
    ...
    if (vowels.indexOf(lowerCasedVal) !== -1) {
        if (newObject[lowerCasedVal]) {
            newObject[lowerCasedVal]++;
        } else {
            newObject[lowerCasedVal] = 1;
        };
    };
   });
return newObject;
...
function removeVowels(str) {
    ...
    let vowels = 'aeiou';
    newArray = lowerCaseString.split("");
    let answer = newArray.filter(function(val) {
